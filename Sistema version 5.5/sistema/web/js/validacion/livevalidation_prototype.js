...
var Validate = {
  ...
  Presence: function(value, paramsObj){
    var params = Object.extend({
      failureMessage: "No puede ser vacio"
    }, paramsObj || {});
  ...
  Numericality: function(value, paramsObj){
    ...
    var params = { 
      notANumberMessage:  paramsObj.notANumberMessage || "Debe ser un numero!",
      notAnIntegerMessage: paramsObj.notAnIntegerMessage || "Debe ser un entro!",
      wrongNumberMessage: paramsObj.wrongNumberMessage || "Debe ser  " + paramsObj.is + "!",
      tooLowMessage:         paramsObj.tooLowMessage || "No debe ser inferior a " + paramsObj.minimum + "!",
      tooHighMessage:        paramsObj.tooHighMessage || "No debe haber mas de " + paramsObj.maximum + "!", 
  ...
  Email: function(value, paramsObj){
    var params = Object.extend({ 
      failureMessage: "Debe ser una dirección de e-mail válida!"
    }, paramsObj || {});
  ...
  Length: function(value, paramsObj){
    ...
    var paramsObj = paramsObj || {};
    var params = { 
      wrongLengthMessage: paramsObj.wrongLengthMessage || "Debe ser  " + paramsObj.is + " Caracteres!",
      tooShortMessage:      paramsObj.tooShortMessage || "No debe ser inferior a " + paramsObj.minimum + " Caracteres!",
      tooLongMessage:       paramsObj.tooLongMessage || "No debe haber más de " + paramsObj.maximum + " Caracteres !",
      is:                           ((paramsObj.is) || (paramsObj.is == 0)) ? paramsObj.is : null,
      minimum:                  ((paramsObj.minimum) || (paramsObj.minimum == 0)) ? paramsObj.minimum : null,
      maximum:                 ((paramsObj.maximum) || (paramsObj.maximum == 0)) ? paramsObj.maximum : null
    }
  ...
  Inclusion: function(value, paramsObj){
    var params = Object.extend({
    failureMessage: "Debe ser incluido en la lista!",
      within:           [],
      allowNull:        false,
      partialMatch:   false,
      caseSensitive: true,
  ...
  Exclusion: function(value, paramsObj){
    var params = Object.extend({
      failureMessage: "No debe ser incluido en la lista!",
      within:             [],
      allowNull:          false,
      partialMatch:     false,
      caseSensitive:   true
  ...
  Confirmation: function(value, paramsObj){
    ...
    var params = Object.extend({
      failureMessage: "No coincide con la Contraseña",
      match:            null
    }, paramsObj || {});
  ...
  Acceptance: function(value, paramsObj){
    var params = Object.extend({
      failureMessage: "Debe ser aceptado!"
    }, paramsObj || {});
