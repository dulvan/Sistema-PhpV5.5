...
var Validate = {
    ...
    Numericality: function(value, paramsObj){
    	...
    	var tooHighMessage = paramsObj.tooHighMessage || "No debe haber más de " + maximum + "!";
   ...
   *                           (DEFAULT: false)
    ...
    Length: function(value, paramsObj){
    	...
    	var tooShortMessage = paramsObj.tooShortMessage || "No debe ser inferior a   " + minimum + " Caracteres!";
    	var tooLongMessage = paramsObj.tooLongMessage || "No debe haber mas de " + maximum + " Caracteres!";
    	switch(true){
    	  	case (is !== null):
    ...
    Confirmation: function(value, paramsObj){
    	...
    	var paramsObj = paramsObj || {};
    	var message = paramsObj.failureMessage || "No coincide con la Contraseña";
