...
<div>
    <!-- titulo de la pagina -->
    <div style="float: left;margin-left: 25px;"><h1 style="color: #467aa7;">Artistas</h1></div>
    <!-- Link para agregar nuevo artista -->
    <div style="float: right; margin-right: 30px;"><h3><a href="artista.php">Nuevo Artista</a></h3></div>
</div>
<br />
