...
<p>Los campo con <span style="color: #D14;">*</span> son Obligatorios</p>
    ...
    if ($editar == 'si') {
        if ($_REQUEST["eliminar"] != 'si')
            echo 'usuarioeditar.php?id=' . @$id2;
        elseif ($_REQUEST["eliminar"] == 'si')
            echo 'usuario.php?id=' . @$id2 . "&eliminar=si";
    } else {
        echo 'usuarioeditar.php';
    }
...
<?php if ($editar == "no") { ?>
                    ...
                    <?php } else { ?>
                        <input name="tipo_cedula" type="hidden" value="<?php echo @$tipo_cedula; ?>" />
                    <?php } ?>
                    <input class="solonumeros" name="num_cedula"  id="num_cedula" value="<?php echo @$num_cedula; ?>" size="8" maxlength="8"  type="<?php echo $editar == "si" ? 'hidden' : 'text'; ?>" />
                    <?php echo $editar == "si" ? ucfirst(@$tipo_cedula) . @$num_cedula : ''; ?>
                        <?php if ($editar == "no") { ?>
                        <span class=" LV_validation_message LV_invalid">
                            <?php echo $registrar->tipo_cedula; ?>       
    <?php echo $registrar->num_cedula; ?>
                        ...
                        <script type="text/javascript">
                            ...
                            num_cedula.add(Validate.Length, {minimum: 6});
...
<?php } ?>
            ...
            <tr>
                ...
                <td><input class="sololetrasespacio" name="nombre" type="text" id="nombre" value="<?php echo @$nombre; ?>" size="30" maxlength="30" />
                    <span class=" LV_validation_message LV_invalid">
<?php echo $registrar->nombre; ?> 
            ...
            <tr>
                ...
                <td><input class="sololetrasespacio"  name="apellido" type="text" id="apellido" value="<?php echo @$apellido; ?>" size="30" maxlength="30" />
                    <span class=" LV_validation_message LV_invalid">
<?php echo $registrar->apellido; ?> 
            ...
            <tr>
                ...
                <td><input class="sololetrasynumeros"  name="usuario" type="text" id="usuario" value="<?php echo @$usuario1; ?>" size="30" maxlength="30" />
...
<?php echo @$error_usuario; ?> 
            ...
            <tr>
                <td  class="ui-state-hover">Telefono/Contacto </td>
...
<?php echo $registrar->telefono; ?> 
            ...
            <tr>
                ...
                <td><input name="email" type="text" id="email" value="<?php echo @$email; ?>" size="30" maxlength="30" />
